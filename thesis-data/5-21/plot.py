...
if __name__ == "__main__":
    ...
    for input_filename in ["barrier",  "chase-lev-deque",  "dekker-change",  "linuxrwlocks",  "mcs-lock",  "mpmc-queue",  "rwlock-test",  "seqlock-test", "left_right", "ring_buf", "bipartite_buf"]:

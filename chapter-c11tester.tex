...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/barrier.pdf}
		\caption{barrier}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/chase-lev-deque.pdf}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/mpmc-queue.pdf}
		\caption{mpmc-queue}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/linuxrwlocks.pdf}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/mcs-lock.pdf}
		\caption{mcs-lock}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/dekker-change.pdf}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/rwlock-test.pdf}
		\caption{rwlock-test}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/seqlock-test.pdf}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/bipartite_buf.pdf}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/left_right.pdf}
		\caption{left-right}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/5-21/ring_buf.pdf}
		\caption{ring-buf}
...
\begin{figure}[H]
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/6-26/barrier.pdf}
		\caption{barrier}
		\label{pctwm-barrier}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/6-26/chase-lev-deque.pdf}
		\caption{chase-lev-deque}
    ...
    \begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/6-26/mcs-lock.pdf}
		\caption{mcs-lock}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/6-26/seqlock-test.pdf}
		\caption{seqlock-test}
    ...
    \begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/6-26/linuxrwlocks.pdf}
		\caption{linuxrwlocks}
	...
	\begin{minipage}{0.45\textwidth}
		\centering
		\includegraphics[width=\textwidth]{thesis-data/6-26/mpmc-queue.pdf}
		\caption{mpmc-queue}
